      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 sm:gap-8">
        ...
        <div className="flex flex-col gap-4 md:col-span-2">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-full gold-gradient-bg flex items-center justify-center text-white font-serif font-bold text-base shadow-sm">
              ॐ
            </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <nav className="flex flex-col gap-2.5 text-sm sm:text-base font-medium">
            <Link href="/" className="hover:text-gold transition-colors text-muted hover:text-foreground">Home</Link>
            <Link href="/classes" className="hover:text-gold transition-colors text-muted hover:text-foreground">Our Classes</Link>
            <Link href="/book" className="hover:text-gold transition-colors text-muted hover:text-foreground">Book A Session</Link>
            <Link href="/contact" className="hover:text-gold transition-colors text-muted hover:text-foreground">Contact</Link>
            <Link href="/admin" className="hover:text-gold transition-colors text-muted hover:text-foreground text-xs mt-2 opacity-50">Admin Panel</Link>
          </nav>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center gap-4 mt-2">
            <a 
              ...
              className="p-2 rounded-full border border-border/80 text-muted hover:text-gold hover:border-gold transition-all duration-300"
